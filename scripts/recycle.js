...

{
  _output:[
    ...
    [/*items*/ [      ["sand",1]                              ]         /*liquids*/,null                        /*power*/,null],
    [/*items*/ [      ["scrap",1]                             ]         /*liquids*/,null                        /*power*/,null],
    [/*items*/ [      ["infinitodustry"+"-"+"stone",1]        ]         /*liquids*/,null                        /*power*/,null],
    [/*items*/ [      ["infinitodustry"+"-"+"scalar",1]       ]         /*liquids*/,null                        /*power*/,null],
    [/*items*/ [      ["infinitodustry"+"-"+"vector",1]       ]         /*liquids*/,null                        /*power*/,null],
    [/*items*/ [      ["infinitodustry"+"-"+"matrix",1]       ]         /*liquids*/,null                        /*power*/,null],
    [/*items*/ [      ["infinitodustry"+"-"+"tensor",1]       ]         /*liquids*/,null                        /*power*/,null],
  ],
  _input:[
    [/*items*/ null                                                     /*liquids*/,null                        /*power*/,null],
